...
dist(mo_chit,saphan_kwai,5).
dist(saphan_kwai,ari,5).
dist(ari,sanam_pao,5).
dist(sanam_pao,victory_monument,5).
dist(victory_monument,phaya_thai,5).
dist(phaya_thai,ratchathewi,5).
dist(ratchathewi,siam,5).
dist(siam,chit_lom,5).
dist(chit_lom,ploen_chit,5).
dist(ploen_chit,nana,5).
dist(nana,asok,5).
dist(asok,phrom_phong,5).
dist(phrom_phong,thong_lo,5).
dist(thong_lo,ekkamai,5).
dist(ekkamai,phra_khanong,5).
dist(phra_khanong,on_nut,5).
dist(on_nut,bang_chak,5).
dist(bang_chak,punnawithi,5).
dist(punnawithi,udom_suk,5).
dist(udom_suk,bang_na,5).
dist(bang_na,bearing,5).
dist(bearing,samrong,5).
%===================================================================
