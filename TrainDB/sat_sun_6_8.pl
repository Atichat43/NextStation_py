...
dist(mo_chit,saphan_kwai,7).
dist(saphan_kwai,ari,7).
dist(ari,sanam_pao,7).
dist(sanam_pao,victory_monument,7).
dist(victory_monument,phaya_thai,7).
dist(phaya_thai,ratchathewi,7).
dist(ratchathewi,siam,7).
dist(siam,chit_lom,7).
dist(chit_lom,ploen_chit,7).
dist(ploen_chit,nana,7).
dist(nana,asok,7).
dist(asok,phrom_phong,7).
dist(phrom_phong,thong_lo,7).
dist(thong_lo,ekkamai,7).
dist(ekkamai,phra_khanong,7).
dist(phra_khanong,on_nut,7).
dist(on_nut,bang_chak,7).
dist(bang_chak,punnawithi,7).
dist(punnawithi,udom_suk,7).
dist(udom_suk,bang_na,7).
dist(bang_na,bearing,7).
dist(bearing,samrong,7).
%===================================================================
